		...
		
{
		...
		String zip = "60174";
			...
			/*Scrabble URL*/
		    driver.get("https://scrabble-apply-now.cs47.force.com/?acctid=0016000000YlgUM");
/*
...
*/ 
			...
			driver.findElement(By.id("Registration:j_id118:lastname")).sendKeys(ln);
			Thread.sleep(500);
			driver.findElement(By.id("Registration:j_id118:phonenumber")).sendKeys(mobile);
			driver.findElement(By.id("Registration:j_id118:email")).sendKeys(email);
			driver.findElement(By.id("Registration:j_id118:confirmemail")).sendKeys(email);
