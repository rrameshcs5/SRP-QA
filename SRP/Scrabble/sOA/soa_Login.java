		...
		
{
		...
		String email = "srp_help_"+arr[3]+"@nomail.com";
			...
			driver.findElement(By.id("Registration:j_id104:usernameLogin")).sendKeys("BDT_Auto_001@nomail.com");
			...
			Thread.sleep(500);
			driver.findElement(By.linkText("SOA-034635")).click(); 
