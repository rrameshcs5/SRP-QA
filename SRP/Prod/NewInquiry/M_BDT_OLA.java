...
/*
			...
			driver.findElement(By.id("Registration:j_id104:usernameLogin")).sendKeys("BDT_Auto_Raja_21@nomail.com");
			...
			Thread.sleep(500);
			driver.findElement(By.linkText("SOA-015538")).click(); 

*/ 

			// Register OLA : 
			driver.findElement(By.id("Registration:j_id118:firstname")).sendKeys("SRP_Help_FN_11");
			driver.findElement(By.id("Registration:j_id118:lastname")).sendKeys("SRP_Help_Ignore_11");
			Thread.sleep(500);
			driver.findElement(By.id("Registration:j_id118:phonenumber")).sendKeys("9879870005");
			driver.findElement(By.id("Registration:j_id118:email")).sendKeys("SRP_Help_Ignore_R11@nomail.com");
			driver.findElement(By.id("Registration:j_id118:confirmemail")).sendKeys("SRP_Help_Ignore_R11@nomail.com");
