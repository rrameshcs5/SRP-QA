		...
		
{
			...
			/*Scrabble URL*/
		    driver.get("https://apply-now.force.com/?acctid=0016000000YlgUM");


			//Login OLA with user name and pwd		
		/*	
			driver.findElement(By.id("Registration:j_id104:usernameLogin")).sendKeys("SRP_Help_Ignore_R151@nomail.com");
			driver.findElement(By.id("Registration:j_id104:passwordLogin")).sendKeys("test1234");
			Thread.sleep(500);
			...
			Thread.sleep(500);
			driver.findElement(By.linkText("SOA-034198")).click(); 
*/


			// Register OLA : 
			driver.findElement(By.id("Registration:j_id118:firstname")).sendKeys("SRP_Help_FN_15");
			driver.findElement(By.id("Registration:j_id118:lastname")).sendKeys("SRP_Help_Ignore_15");
			Thread.sleep(500);
			driver.findElement(By.id("Registration:j_id118:phonenumber")).sendKeys("9879870345");
			driver.findElement(By.id("Registration:j_id118:email")).sendKeys("SRP_Help_Ignore_R15@nomail.com");
			driver.findElement(By.id("Registration:j_id118:confirmemail")).sendKeys("SRP_Help_Ignore_R15@nomail.com");
